...
- 主控：STM32F103C8T6
- 电机：两台 JGB37-520，DC 12 V，6.3:1 减速，输出轴标称 1580 rpm
- 电机驱动：TB6612，两路 20 kHz PWM 和两路正交编码器
...
> [!WARNING]
> 当前固件包含上电直行测试：A1 驱动左轮、B1 驱动右轮，两路均以 10% PWM
> 持续前进。首次烧录必须架空车轮；确认转向正确后再将小车放到地面。
